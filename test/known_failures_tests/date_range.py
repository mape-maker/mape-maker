...
class TestUM(unittest.TestCase):
    ...
    def test_load_sd_ed_less_range(self):
        ...
        # python -m mape_maker "mape_maker/samples/rts_gmlc/Load_forecasts_actuals.csv" -st "actuals" -n 2 -bp "ARMA" -is "2020-1-1 01:00:00" -ie "2020-12-29 23:00:00" -sd "2020-12-30 00:00:00" -ed "2020-12-31 23:00:00" -o "load_actuals_ARMA" -s 1234
    ...
    def test_load_sd_ed_min_range(self):
        ...
        # python -m mape_maker "mape_maker/samples/rts_gmlc/Load_forecasts_actuals.csv" -st "actuals" -n 2 -bp "ARMA" -is "2020-1-1 01:00:00" -ie "2020-12-29 23:00:00" -sd "2020-12-20 00:00:00" -ed "2020-12-31 23:00:00" -o "load_actuals_ARMA" -s 1234
        parm_dict                           = self._base_dict()
        parm_dict["input_file"]             = self.load_rts
        parm_dict["simulated_timeseries"]   = "actuals"
        parm_dict["number_simulations"]     = 2
