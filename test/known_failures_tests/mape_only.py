...
class TestUM(unittest.TestCase):
    ...
    '''
    The first 6 tests are just checking the affect of using the target mape to be 
    dataset's mape, half of the dataset's mape, and twice of the dataset's mape
    '''


    def test_WIND_ops_full_dtmape(self):
        '''
        ...
        # python -m mape_maker "mape_maker/samples/rts_gmlc/wind_operations_example.csv" -st "actuals" -n 2 -bp "ARMA" -is "2020-1-1 01:00:00" -ie "2020-12-29 23:00:00" -sd "2020-12-30 00:00:00" -ed "2020-12-31 23:00:00" -o "full_dtmape" -s 1234
        ...
        parm_dict["output_dir"]             = "full_dtmape"
    ...
    def test_WIND_ops_full_370mape(self):
        '''
        The operational examples are giving very bad scenarios as of now.
        This test is using rts_wind test
        ...
        '''
        print("Running ", str(self.id()).split('.')[2])
        # python -m mape_maker "mape_maker/samples/rts_gmlc/wind_operations_example.csv" -st "actuals" -n 2 -bp "ARMA" -is "2020-1-1 01:00:00" -ie "2020-12-29 23:00:00" -sd "2020-12-30 00:00:00" -ed "2020-12-31 23:00:00" -o "full_370mape" -s 1234 -t 370
        parm_dict                           = self._base_dict()
        parm_dict["input_file"]             = self.wind_ops
        parm_dict["simulated_timeseries"]   = "actuals"
        parm_dict["number_simulations"]     = 2
        ...
        parm_dict["simulation_end_dt"]      = datetime(year=2020, month=12, day=31, hour=23, minute=0, second=0)
        parm_dict["output_dir"]             = "full_370mape"
    ...
    def test_WIND_ops_full_90mape(self):
        '''
        The operational examples are giving very bad scenarios as of now.
        This test is using rts_wind test
        ...
        '''
        print("Running ", str(self.id()).split('.')[2])
        # python -m mape_maker "mape_maker/samples/rts_gmlc/wind_operations_example.csv" -st "actuals" -n 2 -bp "ARMA" -is "2020-1-1 01:00:00" -ie "2020-12-29 23:00:00" -sd "2020-12-30 00:00:00" -ed "2020-12-31 23:00:00" -o "full_90mape" -s 1234  -t 90
        parm_dict                           = self._base_dict()
        parm_dict["input_file"]             = self.wind_ops
        parm_dict["simulated_timeseries"]   = "actuals"
        parm_dict["number_simulations"]     = 2
        ...
        parm_dict["simulation_start_dt"]    = datetime(year=2020, month=12, day=30, hour=0,  minute=0, second=0)
        parm_dict["simulation_end_dt"]      = datetime(year=2020, month=12, day=31, hour=23, minute=0, second=0)
        parm_dict["output_dir"]             = "full_90mape"
    ...
    def test_WIND_ops_30_1200_dtmape(self):
        ...
        '''
        print("Running ", str(self.id()).split('.')[2])
        # python -m mape_maker "mape_maker/samples/rts_gmlc/wind_operations_example.csv" -st "actuals" -n 2 -bp "ARMA" -is "2020-1-1 01:00:00" -ie "2020-12-29 23:00:00" -sd "2020-12-30 12:00:00" -ed "2020-12-31 23:00:00" -o "30_1200_dtmape" -s 1234
        parm_dict                           = self._base_dict()
        parm_dict["input_file"]             = self.wind_ops
        parm_dict["simulated_timeseries"]   = "actuals"
        parm_dict["number_simulations"]     = 2
        ...
        parm_dict["simulation_end_dt"]      = datetime(year=2020, month=12, day=31, hour=23, minute=0, second=0)
        parm_dict["output_dir"]             = "30_1200_dtmape"
    ...
    def test_WIND_ops_30_1200_370mape(self):
        ...
        '''
        print("Running ", str(self.id()).split('.')[2])
        # python -m mape_maker "mape_maker/samples/rts_gmlc/wind_operations_example.csv" -st "actuals" -n 2 -bp "ARMA" -is "2020-1-1 01:00:00" -ie "2020-12-29 23:00:00" -sd "2020-12-30 12:00:00" -ed "2020-12-31 23:00:00" -o "30_1200_370mape" -s 1234 -t 370
        parm_dict                               = self._base_dict()
        parm_dict["input_file"]                 = self.wind_ops
        parm_dict["simulated_timeseries"]       = "actuals"
        parm_dict["number_simulations"]         = 2
        ...
        parm_dict["simulation_start_dt"]        = datetime(year=2020, month=12, day=30, hour=12, minute=0, second=0)
        parm_dict["simulation_end_dt"]          = datetime(year=2020, month=12, day=31, hour=23, minute=0, second=0)
        parm_dict["output_dir"]                 = "30_1200_370mape"
        parm_dict["target_mape"]                = 370
    ...
    def test_WIND_ops_30_1200_90mape(self):
        ...
        '''
        print("Running ", str(self.id()).split('.')[2])
        # python -m mape_maker "mape_maker/samples/rts_gmlc/wind_operations_example.csv" -st "actuals" -n 2 -bp "ARMA" -is "2020-1-1 01:00:00" -ie "2020-12-29 23:00:00" -sd "2020-12-30 12:00:00" -ed "2020-12-31 23:00:00" -o "30_1200_90mape" -s 1234 -t 90
        parm_dict                           = self._base_dict()
        parm_dict["input_file"]             = self.wind_ops
        parm_dict["simulated_timeseries"]   = "actuals"
        parm_dict["number_simulations"]     = 2
        ...
        parm_dict["simulation_start_dt"]    = datetime(year=2020, month=12, day=30, hour=12, minute=0, second=0)
        parm_dict["simulation_end_dt"]      = datetime(year=2020, month=12, day=31, hour=23, minute=0, second=0)
        parm_dict["output_dir"]             = "30_1200_90mape"
        parm_dict["target_mape"]            = 90
        print("parm_dict = ", parm_dict)
        parm_list = list(parm_dict.values())
        # run the test
