...
class TestUM(unittest.TestCase):
    ...
    def test_Bus_220_load(self):
        ...
        # python -m mape_maker "mape_maker/samples/rts_gmlc/operations_example.csv" -st "actuals" -n 5 -bp "ARMA" -is "2020-1-1 01:00:00" -ie "2020-12-29 23:00:00" -sd "2020-12-30 00:00:00" -ed "2020-12-31 23:00:00" -o "operations_example" -s 1234
        ...
        parm_dict["output_dir"]             = "operations_example"
